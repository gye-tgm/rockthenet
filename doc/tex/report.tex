...
\begin{tabular} {| l | c | c | c | c | c |} \hline
	...
	Preparation							& 	9			&				&				&	 		&			\\ \hline
	Documentation						&	5			&				&				&			&			\\ \hline \hline
		
	SNMP-connections (v2 and v3)		& 	10			&				&				& 			&			\\ \hline
	GUI-design							& 	1			&				&				& 			&			\\ \hline
	Thru-put graph						& 	1			&				&				& 			&			\\ \hline
	Data retrieval and mapping			& 	0			&				&				& 			&			\\ \hline
	Dialogs and error handling			&	6			&				&				&			&			\\ \hline
	Information refreshing				&	2			&				&				&			&			\\ \hline
	Rule-table with graph selection		&	2			&				&				&			&			\\ \hline
	SNMP-Trap							&	0			&				&				&			&			\\ \hline
	Emails and notifications			&	1			&				&				&			&			\\ \hline
	SSH-Connection						&	8			&				&				&			&			\\ \hline
	Rule editing implementation			&	0			&				&				&			&			\\ \hline
	Multicast Groups					&	0			&				&				&			&			\\ \hline \hline
...
Multicast connection couldn't be tested because of a very nasty and yet unresolved bug. 
