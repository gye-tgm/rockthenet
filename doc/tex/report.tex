...
Testing was categorized in two sub categories:

\begin{itemize}
	\item Unit Tests (reproduceable with \textit{ant test})
...
For some reasons automated GUI-testing did not work (see section~  \ref{subsec:testfx}).
