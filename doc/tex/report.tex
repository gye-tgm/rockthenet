...
Preparation for the Tasks &	20 & 24.50 \\ \hline
Listing firewall rules & 7 &	9.50 \\ \hline
Refreshing rules &	6 &	0.00 \\ \hline
Visualize thru put & 8 & 5 \\ \hline
Encapsulate the data retrieval &	4 &	4 \\ \hline
GUI	 & 10 &	8 \\ \hline
Final Documentation  &	8	& 5 \\ \hline
Basic Total	& 63 & 56 \\ \hline
\end{tabular}
...
\begin{tabular} {| l | c | c | c | c | c |} \hline
	...
	Preparation							& 	9			&	5			&	0			&	11.5	&			\\ \hline
	Documentation						&	7			&	2			&	0			&	9.5		&			\\ \hline
	Model Design						& 	2			&	0			&	0			& 	10		&			\\ \hline
	Continuous Integration				& 	0			& 	0			& 	0			&	9.5		&			\\ \hline \hline
	GUI									& 	2			&	15			&	0			& 	0		&			\\ \hline
	SNMP-connections					& 	11			&	0			&	0			& 	0		&			\\ \hline
	Thru-put graph						& 	1			&	0			&	0			& 	1.75	&			\\ \hline
	Data retrieval and mapping			& 	0			&	0			&	0			& 	2		&			\\ \hline
	Information refreshing				&	3			&	0			&	0			&	0		&			\\ \hline
	Rule-table with graph selection		&	2			&	3			&	0			&	0		&			\\ \hline \hline
	
	SNMP-Trap							&	0			&	9			&	0			&	0		&			\\ \hline
	Emails and notifications			&	1			&	2			&	0			&	0		&			\\ \hline
	SSH-connection						&	8			&	0			&	0			&	0		&			\\ \hline
	CRUD								& 	3			& 	0			& 	0			&	15		&			\\ \hline
	Multicast Groups					&	0			&	0			&	0			&	4		&			\\ \hline \hline
	Total								&	49		&	36			&	0			&	63.25	&			\\ \hline
...
Visually: controlsfx Notification Pop-up, per email: javax.mail, TrapReceiver: SNMP4J
\\\\
Configure the firewall (ScreenOS) to send SNMP-traps when a rule has changed: problem
\\\\
After looking for info on the web for quite some time we managed to find the following things:
\\\\
Traps included in ScreenOS (e.g. DoS-attack detection traps) {\url{http://kb.juniper.net/InfoCenter/index?page=content&id=KB4439}}] 
\\\\
ScreenOS CLI Reference {\url{https://cs.uwaterloo.ca/cscf/internal/manuals/netscreen/cli_5_0.pdf}}
\\\\
For our 5xHIT community we can enable authentication-traps via 
\begin{lstlisting}
set snmp auth-trap enable. 
\end{lstlisting}
We did not manage to find a command/way to configure SNMP-Traps to be sent when a rule is changed on the firewall.
