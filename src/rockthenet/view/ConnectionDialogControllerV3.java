...
public class ConnectionDialogControllerV3 {
    ...
    private void handleOk() {
        if (isInputValid()) {
            if (controller.establishConnectionV3(addressV3.getText(), Integer.parseInt(portV3.getText()),
                    username.getText(), authentificationPassword.getText(), securityPassword.getText())) {
                okClicked = true;
                dialogStage.close();
            }
        }
