...
public class SSHConnectionFactory {
    ...
    /**
     * Creates a new established {@link rockthenet.connections.ssh.SSHConnection}
     *
     * @param host     the host address of the SSH-server (IP or URL)
     * @param username the username to use for connecting
     * @param password the corresponding password
     * @return a ready to use {@link rockthenet.connections.ssh.SSHConnection} with the specified parameters
     * @throws ConnectionException thrown if connecting failed (see Exception-message for more information)
     */
    public static WriteConnection createSSHConnection(String host, String username,
