...
public class SNMPv3Connection extends SNMPConnection {
    ...
    /**
     * Equivalent to {@code SNMPv3Connection(address, port, username, authPassword, privPassword, AUTH_PROTOCOL,
     *PRIV_PROTOCOL)
     *
     * @see #SNMPv3Connection(String, int, String, String, String, OID, OID)
     */
    protected SNMPv3Connection(String address, int port, String username, String authPassword,
    ...
    protected SNMPv3Connection(String address, int port, String username, String authPassword, String privPassword,
                               OID authProtocol, OID privProtocol) throws ConnectionException {
        ...
        this.user = new UsmUser(new OctetString(username), authProtocol, new OctetString(authPassword), privProtocol,
